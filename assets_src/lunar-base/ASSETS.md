...
| 002 | Blue Moon Mk2 | 3 | **draft v002 — art pass pending** | `assets/mk2/mk2_v002.blend` (+ `BRIEF.md`) | v002 = remodel to the official render Kari supplied (`ref/blue_moon_mk2_crewed/`): truss-caged tank lobes, stair gantry, gold MLI legs/skirt, dome crown w/ blue band. Dome gore seams deferred to art-pass bump work. Validator 8/8; turnarounds `D:\renders\lunar-base\assets\mk2_v002\` |
