...
| 002 | Blue Moon Mk2 | 3 | **draft v001 — art pass pending** | `assets/mk2/mk2_v001.blend` (+ `BRIEF.md`, gate-approved) | 16.0 m datum; 106 objects, emissive windows, no interior; validator 8/8; turnarounds `D:\renders\lunar-base\assets\mk2_v001\` |
